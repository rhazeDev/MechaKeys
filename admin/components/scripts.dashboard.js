async function loadDashboard() {
    try {
        ...
        if (result.success) {
            ...
            setIfExists('deliveryRidersCount', stats.delivery_riders || 0);
            setIfExists('activeDeliveriesCount', stats.active_deliveries || 0);
            setIfExists('deliveredTodayCount', stats.delivered_today || 0);
            setIfExists('pendingAssignmentsCount', stats.pending_assignments || 0);
