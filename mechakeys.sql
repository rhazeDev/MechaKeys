...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2025 at 01:49 PM
...
(18, 7, 75, 'Beige', 'Famicom', 4320.00, 11),
...
(3, 'Justine Delivery', 'delivery@gmail.com', '123456', '09283028474', 'J. P. Rizal Avenue Bgy. No. 1, Laoag City, Ilocos Norte, Philippines', '120.6841026,18.0765704', 'delivery', 0.00, '2025-10-26 19:16:54'),
...
--
ALTER TABLE `notifications`
  MODIFY `NotificationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;
...
--
ALTER TABLE `remittance_logs`
  MODIFY `RemittanceLogID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `return_items`
  MODIFY `ReturnItemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `rider_remittances`
--
ALTER TABLE `rider_remittances`
  MODIFY `RemittanceID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `trackings`
--
ALTER TABLE `trackings`
  MODIFY `TrackingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
